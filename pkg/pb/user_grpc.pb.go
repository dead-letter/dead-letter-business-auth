...
type UserServiceClient interface {
	...
	ReadUserWithCredentials(ctx context.Context, in *ReadUserWithCredentialsRequest, opts ...grpc.CallOption) (*User, error)
...
func (c *userServiceClient) ReadUserWithCredentials(ctx context.Context, in *ReadUserWithCredentialsRequest, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, UserService_ReadUserWithCredentials_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServiceServer interface {
	...
	ReadUserWithCredentials(context.Context, *ReadUserWithCredentialsRequest) (*User, error)
...
func (UnimplementedUserServiceServer) ReadUserWithCredentials(context.Context, *ReadUserWithCredentialsRequest) (*User, error) {
...
func _UserService_ReadUserWithCredentials_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReadUserWithCredentialsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServiceServer).ReadUserWithCredentials(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: UserService_ReadUserWithCredentials_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).ReadUserWithCredentials(ctx, req.(*ReadUserWithCredentialsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var UserService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _UserService_ReadUserWithCredentials_Handler,
		},
		{
