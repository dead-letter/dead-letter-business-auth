...
func (x *Vendor) GetVersion() int32 {
	if x != nil {
		return x.Version
	}
	return 0
...
const file_vendor_proto_rawDesc = "" +
	"\n" +
	"\fvendor.proto\x12\x04data\"2\n" +
	"\x06Vendor\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x05R\aversion\"%\n" +
	"\x13CreateVendorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"#\n" +
	"\x11ReadVendorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"?\n" +
	"\x13UpdateVendorRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x18\n" +
	"\aversion\x18\x02 \x01(\x05R\aversion2\xb6\x01\n" +
	"\rVendorService\x127\n" +
	"\fCreateVendor\x12\x19.data.CreateVendorRequest\x1a\f.data.Vendor\x123\n" +
	"\n" +
	"ReadVendor\x12\x17.data.ReadVendorRequest\x1a\f.data.Vendor\x127\n" +
	"\fUpdateVendor\x12\x19.data.UpdateVendorRequest\x1a\f.data.VendorB5Z3github.com/dead-letter/dead-letter-data/internal/pbb\x06proto3"
...
var file_vendor_proto_depIdxs = []int32{
	...
	0, // 3: data.VendorService.CreateVendor:output_type -> data.Vendor
	0, // 4: data.VendorService.ReadVendor:output_type -> data.Vendor
	0, // 5: data.VendorService.UpdateVendor:output_type -> data.Vendor
